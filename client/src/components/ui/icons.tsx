...
export const Icons: IconType = {
  ...
  cleaning: (props: LucideProps) => <Eraser {...props} />,
  ...
  maximize: (props: LucideProps) => <Maximize2 {...props} />,
  more: (props: LucideProps) => <MoreHorizontal {...props} />,
  menu: (props: LucideProps) => <Menu {...props} />,
  next: (props: LucideProps) => <ChevronRight {...props} />,
